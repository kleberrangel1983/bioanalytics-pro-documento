...
|---|---|---|---|---|---|---|---|
| PR-01 | Plataforma/Qualidade | Gate de qualidade | TODO | - | 0/4 | Baixo | Coordenação |
| PR-02 | Comunicação | Confirmação WhatsApp | TODO | - | 0/4 | Médio | Secretária |
| PR-03 | Segurança/Auditoria | Log de auditoria | TODO | - | 0/4 | Alto | Médico responsável |
| PR-04 | CRM/Operação | Filtro CRM | TODO | - | 0/4 | Médio | Secretária |
| PR-05 | Integração/Release | Relatório final | TODO | Depende PR-02/03/04 | 0/4 | Baixo | Coordenação |
